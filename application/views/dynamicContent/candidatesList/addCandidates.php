    ...
    <div class="card-body">
      ...
      <form class="">
        ...
        <div class="position-relative form-group">
          ...
          <input type="email" name="" id="" placeholder="abc@example.com" class="form-control">
        </div>
        <div class="position-relative form-group">
          <label for="" class="">Applied Position</label>
          <select class="form-control" name="">
            <option value=""></option>
          </select>
        </div>
        ...
        <div class="position-relative form-group">
          <label for="" class="">Expected Salary</label>
        ...
        <input type="submit" class="mt-2 btn btn-primary" name="" value="Add">
      </form>
    </div>
  </div>

</div>
<script src="<?= base_url('assets/js/controlFlow.js') ?>" charset="utf-8"></script>
